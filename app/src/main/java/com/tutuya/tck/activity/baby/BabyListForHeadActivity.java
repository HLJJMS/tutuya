...
import com.tutuya.tck.adapter.BabyListForHeadAdapter;
...
宝宝信息列表
*/
public class BabyListForHeadActivity extends BaseActivity {
    ...
    ImageView listNull;
    private BabyListForHeadAdapter adapter;
    ...
    private void aboutRecycler() {
        adapter = new BabyListForHeadAdapter(this);
        list.setAdapter(adapter);

        //        recyclerview回调监听（删除）
        adapter.setDelItem(new BabyListForHeadAdapter.DelItem() {
            @Override
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.add:
//                showToast("功能暂未开放");
                Intent intent = new Intent(BabyListForHeadActivity.this, AddHeadTestActivity.class);
