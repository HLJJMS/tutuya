...
public class SwipeRecycler extends RecyclerView {
    ...
    //recyclerView距离屏幕上方摄像头的距离
    private int errorSize = 249;
...
//            if(i==f){
//                errorSize = location[1];
//            }
//            view.getLocationInWindow(location);
            int a =view.getWidth();
            int b = view.getHeight();
            if (e.getY() < location[1]-errorSize+ view.getHeight() && e.getY() > location[1]-errorSize  && e.getX() > location[0] && e.getX() < location[0] + view.getWidth()) {
                return i;
            }
//            if(e.getY()>location[1]&&e.getY()<location[1]+view.getHeight()){
//                return i;
//            }
        }
        return -1;
    ...
    //    带动画的关闭
    public void closeExAnim(){
        ViewHolder viewHolder = findViewHolderForAdapterPosition(add);
        ValueAnimator anim = ValueAnimator.ofInt(-dp2px(90),0);
        ...
        if (viewHolder != null){
            ...
            anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    Log.e("動畫",String.valueOf(currentValue));
                    view.setPadding(currentValue, view.getPaddingTop(), view.getPaddingRight(), view.getPaddingBottom());
                }
            });
            anim.start();
        }
    ...
    public int getScreenWidth(){
        ...
        return new Double(displayMetrics.widthPixels*0.92).intValue();
    }
